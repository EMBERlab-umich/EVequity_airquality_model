...
df = pd.read_csv("data/GEOID_to_Centroid.csv", dtype={'w_geocode': str, 'h_geocode': str})

# Filter for GEOIDs that start with '6085' (Santa Clara County) 
...
sb_df.to_csv("data/santa_clara_geoids.csv", index=False)
